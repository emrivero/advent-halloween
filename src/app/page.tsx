    ...
    <div className="mx-auto max-w-6xl py-10">
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2">
        ...
        >
          <div className="rounded-2xl bg-gray-950/95 p-6 md:p-7 h-full flex flex-col">
            ...
            <p className="mt-3 text-white/80">
              Crea un plan a medida: número de pelis, días concretos, progreso
              sincronizado y opción de compartir tu calendario.
            </p>
        ...
        <div className="rounded-2xl border border-white/10 bg-gray-950/70 p-6 md:p-7">
          ...
          <p className="mt-3 text-white/80">
            Prueba rápida sin cuenta: calendario clásico de octubre, una peli
            por día, desbloqueo automático y orden aleatorio local.
          </p>
